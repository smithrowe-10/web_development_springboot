...
/*
    New project 생성시 주의점 :
        ...
        2. DLS -> Groovy 설정
        3. name = ArtifactId
        4. build.gradle 설정을 복사하는데, 복사 후에 -> sync 를 꼭꼭 눌러주셔야 합니다.
            -> SpringBootDeveloperApplication 에서 @@SpringBootApplication 애너테이션이 빨간줄 가있다면
            새로고침 안했을 확률이 거의 90%
...
/*
    1. Spring vs. SpringBoot
        ...
        Enterprise Application : 대규모의 복잡한 데이터를 관리하는 애플리케이션
            ...
            모든 걸 신경쓰면서 사이트 기능, 즉 'ㅂㅣ지니스 로직'을 개발하기가 매우 어려워서
            등장하게 된 것이 Spring
        ...
        2. 스프링 컨셉
            ...
            2) 의존성 주입(DI)
                ...
                Bean : 스프링 컨테이너가 관리하는 객체 -> 추후 한번 더 수업할 예정입니다.
            ...
            3) 빈과 스프링 컨테이너
                ...
                5) 이식 가능한 서비스 추상화(PSA)
                    Portable Service Abstraction : 스프링에서 제공하는 다양한 기술들을 추상화 해
                        ...
                        WAS 역시 PAS 의 예시 중 하나로, 어떤 서버를 사용하더라도(톰캣, 언더토우, 네티 등)
                        코드를 동일하게 작성 가능
